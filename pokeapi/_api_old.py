...
@dataclass
class NamedAPIResourceList(APIType):
...
class EvolutionChain(HasEndpoint):
    ...
    baby_trigger_item: NamedAPIResource[Item] = NamedAPIResource("", "")
...
class MoveMetaData(APIType):
    ...
    ailment: NamedAPIResource[MoveAilment] = NamedAPIResource("", "")

    # The category of move this move falls under, e.g. damage or ailment.
    category: NamedAPIResource[MoveCategory] = NamedAPIResource("", "")
